...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await api.post("/api/auth/register/", { email, nom, password });
    ...
    >
      <form className="space-y-5" onSubmit={onSubmit}>
        ...
        {submitStatus === "success" && (
          <p className="text-sm font-medium rounded-xl px-3 py-2 border bg-[var(--color-primary-light)] border-[var(--color-primary)] text-[var(--color-primary)] flex items-center gap-2">
        ...
        >
          ...
          {submitStatus === "submitting" ? "Création du compte..." : "Créer mon compte"}
        </Button>
